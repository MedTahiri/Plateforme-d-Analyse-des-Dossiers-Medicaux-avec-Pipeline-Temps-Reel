            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-6">
                <Avatar className="h-20 w-20 ring-4 ring-blue-100">
                  <AvatarFallback className="bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold text-2xl">
                ...
                <Card className="border-0 shadow-xl bg-white/80 backdrop-blur-sm">
                  ...
                  <CardContent className="p-6">
                    <div className="flex flex-col items-center justify-center py-12 text-gray-500">
                      ...
                      <h3 className="text-lg font-medium mb-2">Dossier médical en cours de développement</h3>
                      <p className="text-center max-w-md">
                        Cette section contiendra bientôt l'historique médical complet,
                        les prescriptions, les résultats d'examens et autres informations cliniques.
                      </p>
                    </div>
                  </CardContent>
                </Card>
